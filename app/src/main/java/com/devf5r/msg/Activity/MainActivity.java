...
import com.devf5r.msg.Adapter.TabAdapter;
import com.devf5r.msg.BuildConfig;
...
import com.devf5r.msg.Utils.FavoriteDatabase;
import com.devf5r.msg.Utils.GDPR;
import com.devf5r.msg.Utils.PrefManager;

import static com.devf5r.msg.Utils.Constant.ADMOB;
import static com.devf5r.msg.Utils.Constant.AD_STATUS_ON;
import static com.devf5r.msg.Utils.Constant.APPLOVIN;
...
import static com.devf5r.msg.Utils.Constant.STARTAPP;
import static com.devf5r.msg.Utils.Constant.UNITY;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    private static final String ONESIGNAL_APP_ID = "a6ab1901-c80f-4676-890c-74983bc2fa9c";
    PrefManager prf;
    AdNetwork adNetwork;
    AdsPref adsPref;
    ...
    //    }
        ...
        if (menuItem.getItemId() == R.id.nav_contact){
            ...
            i.putExtra(Intent.EXTRA_TEXT   , getResources().getString(R.string.version_label));
            try {
        ...
        if (menuItem.getItemId() == R.id.nav_facebook){
         ...
         if (menuItem.getItemId() == R.id.nav_my_telegram){

            Intent browserIntent = new Intent(Intent.ACTION_VIEW,
                    Uri.parse("https://t.me/"+Config.Telegram_My));
            startActivity(browserIntent);
        }
